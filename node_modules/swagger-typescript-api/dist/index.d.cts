...
declare class ResolvedSwaggerSchema {
  ...
  private splitGithubRefAndFilePath;
...
interface GenerateApiConfiguration {
  ...
  config: {
     ...
     */
    defaultResponseAsSuccess: boolean; /** request parameters for each API request */
    defaultRequestParams: string; /** generate type definitions for API routes */
